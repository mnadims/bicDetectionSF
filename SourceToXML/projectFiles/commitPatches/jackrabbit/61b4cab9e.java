From 61b4cab9ef4ab212dcceab2ccda7c0fb3242f87a Mon Sep 17 00:00:00 2001
From: Angela Schreiber <angela@apache.org>
Date: Wed, 23 Oct 2013 18:20:14 +0000
Subject: [PATCH] JCR-3686 : Prevent removal/move of admin node
...
--
 ...
 .../core/security/user/UserManagerImpl.java   |  11 +
 .../core/security/user/AdministratorTest.java | 219 ++++++------------
...
index ff32888e9..2df3ea284 100644
...
@@ -933,6 +934,10 @@ public class BatchedItemOperations extends ItemValidator {
...
index eb08c5681..33d11d42a 100644
...
@@ -33,6 +33,7 @@ import org.apache.jackrabbit.core.nodetype.EffectiveNodeType;
...
@@ -302,6 +303,10 @@ public class ItemValidator {
...
index dcdc91d5b..c87a1f0a1 100644
...
index 621891b59..c7946f2db 100644
...
@@ -72,13 +65,6 @@ public class AdministratorTest extends AbstractUserTest {
         }
     }
...
@@ -86,141 +72,98 @@ public class AdministratorTest extends AbstractUserTest {
    ...
    public void testWorkspaceMoveAdminNode()  throws RepositoryException, NotExecutableException {
         ...
         if (admin == null || !(admin instanceof AuthorizableImpl)) {
@@ -228,41 +171,13 @@ public class AdministratorTest extends AbstractUserTest {
         }
