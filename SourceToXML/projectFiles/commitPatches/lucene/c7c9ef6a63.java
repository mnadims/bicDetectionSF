From c7c9ef6a6346fc41f7a5fae6d0f188b8ee34a3e5 Mon Sep 17 00:00:00 2001
From: Grant Ingersoll <gsingers@apache.org>
Date: Wed, 1 Apr 2009 20:07:44 +0000
Subject: [PATCH] SOLR-1095: fix stopword and keep filter performance issue

git-svn-id: https://svn.apache.org/repos/asf/lucene/solr/trunk@761036 13f79535-47bb-0310-9956-ffa450edef68
--
 CHANGES.txt                                   |  2 +
 .../apache/solr/analysis/KeepWordFilter.java  |  2 +-
 .../solr/analysis/KeepWordFilterFactory.java  | 42 ++++++------
 .../solr/analysis/StopFilterFactory.java      | 22 +++---
 .../solr/analysis/TestKeepFilterFactory.java  | 65 ++++++++++++++++++
 .../solr/analysis/TestStopFilterFactory.java  | 66 ++++++++++++++++++
 src/test/org/apache/solr/util/TestUtils.java  |  4 ++
 src/test/test-files/solr/conf/keep-1.txt      | 17 +++++
 src/test/test-files/solr/conf/keep-2.txt      | 17 +++++
 .../test-files/solr/conf/schema-stop-keep.xml | 67 +++++++++++++++++++
 src/test/test-files/solr/conf/stop-1.txt      | 17 +++++
 src/test/test-files/solr/conf/stop-2.txt      | 17 +++++
 12 files changed, 305 insertions(+), 33 deletions(-)
 create mode 100644 src/test/org/apache/solr/analysis/TestKeepFilterFactory.java
 create mode 100644 src/test/org/apache/solr/analysis/TestStopFilterFactory.java
 create mode 100644 src/test/test-files/solr/conf/keep-1.txt
 create mode 100644 src/test/test-files/solr/conf/keep-2.txt
 create mode 100644 src/test/test-files/solr/conf/schema-stop-keep.xml
 create mode 100644 src/test/test-files/solr/conf/stop-1.txt
 create mode 100644 src/test/test-files/solr/conf/stop-2.txt

diff --git a/CHANGES.txt b/CHANGES.txt
index bd462d9c735..b76be9dfdaf 100644
-- a/CHANGES.txt
++ b/CHANGES.txt
...
index 5ff2881c92d..cd8ad472d29 100644
...
index 101df6394ef..66f5709dcb8 100644
...
index 0126952a7bc..0b4f6b780a1 100644
...
index d8e47528abf..1ee2c068cf8 100755
